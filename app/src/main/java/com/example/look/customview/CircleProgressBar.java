...
public class CircleProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            strokeWidth = typedArray.getDimension(R.styleable.CircleProgressBar_c_progressBarThickness, strokeWidth);
            progress = typedArray.getFloat(R.styleable.CircleProgressBar_c_progress, progress);
            color = typedArray.getInt(R.styleable.CircleProgressBar_c_progressbarColor, color);
            min = typedArray.getInt(R.styleable.CircleProgressBar_c_min, min);
            max = typedArray.getInt(R.styleable.CircleProgressBar_c_max, max);
        } finally {
            typedArray.recycle();
        }
